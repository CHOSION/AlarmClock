...
struct Home: View {
    @State var currentTime = Time(ss: 0, mm: 0, hh: 0)
...
//                    .padding(.top, 35)
            ...
            ZStack {// Dial
                ...
                Rectangle()
                    ...
                    .rotationEffect(.init(degrees: Double(currentTime.mm) * 6))
                ...
                Rectangle()
                    ...
                    .rotationEffect(.init(degrees: Double(currentTime.hh + currentTime.mm / 60) * 30))
                ...
                Rectangle()
                    ...
                    .rotationEffect(.init(degrees: Double(currentTime.ss) * 6))
        ...
        .onAppear(perform: {
            ...
            withAnimation(Animation.linear(duration: 0.01)){
                currentTime = Time(ss: sec, mm: min, hh: hour)
            }
        })
